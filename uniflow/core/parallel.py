...
class ParallelExecutor:
    ...
    Example:
        ```python
        from uniflow.core.parallel import ParallelExecutor
...
def parallel_map(
    ...
    Example:
        ```python
        from uniflow.core.parallel import parallel_map
...
class DataParallelExecutor:
    ...
    Example:
        ```python
        from uniflow.core.parallel import DataParallelExecutor
...
class BatchExecutor:
    ...
    Example:
        ```python
        from uniflow.core.parallel import BatchExecutor
