...
class ResourceConfig:
    ...
    gpu: Optional[str] = None  # e.g., "nvidia-tesla-t4", "nvidia-tesla-v100"
    gpu_count: int = 0
    disk_size: str = "10Gi"
    machine_type: Optional[str] = None  # Cloud-specific machine type
...
class DockerConfig:
    ...
    image: Optional[str] = None  # e.g., "gcr.io/myproject/uniflow:latest"
    dockerfile: Optional[str] = None  # Path to Dockerfile
    build_context: str = "."
    requirements: Optional[List[str]] = None  # Python requirements
