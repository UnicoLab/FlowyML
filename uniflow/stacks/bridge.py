"""Generic Bridge for adapting external components to UniFlow.
...
class AdaptationRule:
    ...
    method_mapping: dict[str, str] = field(default_factory=dict)  # uniflow_method -> external_method
    attribute_mapping: dict[str, str] = field(default_factory=dict)  # uniflow_attr -> external_attr
...
class GenericBridge:
    ...
    def wrap_component(
        ...
        Returns:
            A UniFlow StackComponent class that wraps the external component
        """
