...
class StackRegistry:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.active_stack_name: Optional[str] = None
        ...
        if name in self.stacks:
            ...
            if self.active_stack_name == name:
                self.active_stack_name = (
                    list(self.stacks.keys())[0] if self.stacks else None
                )
    ...
    def save(self) -> None:
        ...
        config = {
            ...
            "stacks": {
                name: self._serialize_stack(stack)
    ...
    def load(self) -> None:
        ...
        try:
            ...
            print(f"Warning: Could not load stack configuration: {e}")
...
_global_registry: Optional[StackRegistry] = None
