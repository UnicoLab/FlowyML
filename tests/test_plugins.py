...
from uniflow.stacks.components import (
    Orchestrator, ArtifactStore, ContainerRegistry,
    ComponentType, ResourceConfig, DockerConfig
)
...
class TestComponentRegistry(unittest.TestCase):
    ...
    def test_register_orchestrator(self):
        ...
        class TestOrchestrator(Orchestrator):
            ...
            def run_pipeline(self, pipeline, **kwargs): return "test_run"
            def get_run_status(self, run_id): return "SUCCESS"
            def to_dict(self): return {"type": "test"}
    ...
    def test_register_artifact_store(self):
        ...
        class TestArtifactStore(ArtifactStore):
            def validate(self): return True
            def save(self, artifact, path): return f"saved:{path}"
            def load(self, path): return f"loaded:{path}"
    ...
    def test_register_container_registry(self):
        ...
        class TestContainerRegistry(ContainerRegistry):
            def validate(self): return True
            def push_image(self, image_name, tag="latest"): return f"{image_name}:{tag}"
            def pull_image(self, image_name, tag="latest"): pass
            def get_image_uri(self, image_name, tag="latest"): return f"reg/{image_name}:{tag}"
            def to_dict(self): return {"type": "test"}
    ...
    def test_get_component(self):
        ...
        class TestOrchestrator(Orchestrator):
            def validate(self): return True
            def run_pipeline(self, pipeline, **kwargs): return "test"
            def get_run_status(self, run_id): return "SUCCESS"
...
class TestRegisterDecorator(unittest.TestCase):
    ...
    def test_decorator_auto_registers(self):
        ...
        class DecoratedOrchestrator(Orchestrator):
            def validate(self): return True
            def run_pipeline(self, pipeline, **kwargs): return "decorated"
            def get_run_status(self, run_id): return "SUCCESS"
            def to_dict(self): return {"type": "decorated"}
    ...
    def test_decorator_with_custom_name(self):
        ...
        class AnotherOrchestrator(Orchestrator):
            def validate(self): return True
            def run_pipeline(self, pipeline, **kwargs): return "custom"
            def get_run_status(self, run_id): return "SUCCESS"
            def to_dict(self): return {}
...
class TestComponentValidation(unittest.TestCase):
    ...
    def test_orchestrator_validation(self):
        ...
        class ValidatingOrchestrator(Orchestrator):
            ...
            def run_pipeline(self, pipeline, **kwargs): return "test"
            def get_run_status(self, run_id): return "SUCCESS"
            def to_dict(self): return {"config": self.config_value}
    ...
    def test_artifact_store_validation(self):
        ...
        class ValidatingStore(ArtifactStore):
            ...
            def to_dict(self): return {"endpoint": self.endpoint}
...
class TestGlobalRegistry(unittest.TestCase):
    ...
    def test_global_registry_persistence(self):
        ...
        class PersistentOrchestrator(Orchestrator):
            def validate(self): return True
            def run_pipeline(self, pipeline, **kwargs): return "persistent"
            def get_run_status(self, run_id): return "SUCCESS"
            def to_dict(self): return {}
