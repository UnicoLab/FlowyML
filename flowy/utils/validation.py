"""Pydantic schemas and validation utilities for Flowy."""
...
class StackConfig(BaseModel):
    ...
    artifact_store_path: str = Field(".flowy/artifacts", description="Artifact storage path")
    metadata_store_path: str = Field(".flowy/metadata.db", description="Metadata storage path")
