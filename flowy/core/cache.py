...
class CacheStore:
    ...
    def __init__(self, cache_dir: str = ".flowy/cache"):
    ...
    def set(self, key: str, value: Any, step_name: str, code_hash: str, 
            input_hash: Optional[str] = None):
        """
    ...
    def invalidate(self, key: Optional[str] = None, step_name: Optional[str] = None):
        """
