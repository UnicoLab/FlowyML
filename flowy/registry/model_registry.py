...
class ModelRegistry:
    ...
    def __init__(self, registry_path: str = ".flowy/model_registry"):
    ...
    def _save_model(self, model: Any, path: Path, framework: str) -> None:
        ...
        """
        from flowy.storage.materializers import get_materializer
    ...
    def _load_model(self, path: Path, framework: str) -> Any:
        ...
        Returns:
            Loaded model
        """
        from flowy.storage.materializers import materializer_registry
